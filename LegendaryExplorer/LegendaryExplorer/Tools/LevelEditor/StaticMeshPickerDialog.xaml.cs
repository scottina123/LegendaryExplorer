...
/// <summary>
/// Represents a StaticMesh export found in the local package.
/// </summary>
public record LocalStaticMeshItem(int UIndex, string DisplayName);

/// <summary>
/// A picker dialog that lets the user choose a static mesh either from the
...
public partial class StaticMeshPickerDialog : NotifyPropertyChangedWindowBase
{
    ...
    public ObservableCollectionExtended<LocalStaticMeshItem> AllLocalMeshes { get; } = [];
    public ObservableCollectionExtended<LocalStaticMeshItem> FilteredLocalMeshes { get; } = [];

    private LocalStaticMeshItem _selectedLocalMesh;
    public LocalStaticMeshItem SelectedLocalMesh
    {
    ...
    public StaticMeshPickerDialog(MEGame game, IMEPackage package, Window owner = null)
    {
        _game = game;
        _package = package;
        DataContext = this;
    ...
    private void PopulateLocalMeshes()
    {
        ...
        {
            if (exp.IsA("StaticMesh"))
            {
                AllLocalMeshes.Add(new LocalStaticMeshItem(exp.UIndex,
