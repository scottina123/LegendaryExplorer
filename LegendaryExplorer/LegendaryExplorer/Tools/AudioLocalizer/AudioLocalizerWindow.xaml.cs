...
namespace LegendaryExplorer.Tools.AudioLocalizer
{
    /// <summary>
    /// Interaction logic for AudioLocalizerWindow.xaml
    /// </summary>
    public partial class AudioLocalizerWindow : TrackingNotifyPropertyChangedWindowBase
    {
        private readonly object _localizationTasksLock = new();
        ...
        public AudioLocalizerWindow() : base("Audio Localizer", true)
        {
            DataContext = this;
            LoadCommands();
            InitializeComponent();
        ...
        private Dictionary<string, Dictionary<string, Wwisestreaminfo>> GetLocalizationInfo()
        {
            ...
            var langRegex = new Regex(".+LOC_(.+).pcc");
