...
public static class ToolSet
{
    ...
    public static void Initialize()
    {
        ...
        set.Add(new Tool
        {
            ...
            tags = ["user", "toc", "tocing", "crash", "infinite", "loop", "loading"],
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "toolsetdev", "animation"],
            category = "Toolset Devs",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "animation", "gesture"],
        ...
        set.Add(new Tool
        {
            ...
            open = () =>
            {
                var gameStr = InputComboBoxWPF.GetValue(null, "Choose game you want to use Script Debugger with.", "Script Debugger game selector",
                    ScriptDebuggerWindow.SupportedGames.Select(x => x.ToString()), "LE3", getDefaultValueFunc: GameController.GetRunningMEGameStrDelegate(ScriptDebuggerWindow.SupportedGames));
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "localization", "LOC_INT", "translation"],
            category = "Audio Tools",
            category2 = "Utilities",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "dlc", "sfar", "unpack", "extract"],
            category = "Extractors + Repackers",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "code", "endian", "convert", "integer", "float"],
            category = "Utilities",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "dialogue", "matinee", "cutscene", "animcutscene", "interpdata"],
            category = "Cinematic Tools",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "startup", "import", "custom", "file", "class", "kismet"],
            category = "Utilities",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "mesh", "meshplorer"],
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "animation", "psa", "animset", "animsequence"],
            category = "Extractors + Repackers",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "dialogue", "subtitle", "text", "string"],
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "package", "pcc", "text", "dump"],
            category = "Utilities",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "convo", "dialogue", "text", "dump"],
            category = "Utilities",
            category2 = "Extractors + Repackers",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "mesh", "material", "class", "animation"],
            category = "Utilities",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["utility", "deployment", "textures", "compression"],
            category = "Meshes + Textures",
            category2 = "Utilities",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "conditional", "plot", "boolean", "flag", "int", "integer", "cnd"],
            category = "Core Editors",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "me1", "me2", "me3", "cutscene"],
            category = "Core Editors",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "fxa", "facefx", "lipsync", "fxe", "bones", "animation", "me3", "me3"],
            category = "Cinematic Tools",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "mount", "dlc", "me2", "me3"],
            category = "Utilities",
            category2 = "Core Editors",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "dialogue", "subtitle", "text", "string", "localize", "language"],
            category = "Core Editors",
            category2 = "Utilities",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["user", "developer", "pcc", "cloning", "import", "export", "sfm", "upk", ".u", "me2", "me1", "me3", "name"],
            category = "Core Editors",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "codex", "state transition", "quest", "natives"],
            category = "Core Editors",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "codex", "state transition", "quest", "plots", "database", "conditional"],
            category = "Core Editors",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["user", "developer", "kismet", "me1", "me2", "me3"],
            category = "Core Editors",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["texture", "developer", "studio", "graphics"],
            category = "Meshes + Textures",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["user", "developer", "audio", "dialogue", "music", "wav", "ogg", "sound", "afc", "wwise", "bank", "soundplorer"],
            category = "Audio Tools",
        ...
        set.Add(new Tool
        {
            ...
            tags = ["developer", "audio", "music", "sound", "wwise", "bank"],
            category = "Audio Tools",
